...
for (var i = 0; i < questionsArray.length; i++) {
  ...
  a.attr("data-name",possAnswers[i]);
  // Providing the initial button text
  a.text(possAnswers[i]);
...
//  Clear intervalId first so we don't create floating timers.
...
$(".question-btn").on("click", function (event) {
  ...
  // Calling renderButtons which handles the processing of our questions  array
  renderButtons();
});
